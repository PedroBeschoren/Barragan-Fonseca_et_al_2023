...
neutral_metacoder_BO<-parse_phyloseq(goodSamples_heatTrees )
...
neutral_metacoder_BO$data$tax_occ <- calc_n_samples(obj = neutral_metacoder_BO, 
                                    data = "tax_abund", 
                                    groups = neutral_metacoder_BO$data$sample_data$Treatment, 
                                    cols = neutral_metacoder_BO$data$sample_data$sample_id)
...
neutral_metacoder_BO$data$diff_table <- compare_groups(obj = neutral_metacoder_BO,
                                      ...
                                      groups = neutral_metacoder_BO$data$sample_data$Treatment) # What category each sample is assigned to
